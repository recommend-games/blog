...
## #2: {{% game 314503 %}}Codex Naturalis{{% /game %}}
...
## #3: {{% game 339484 %}}Savannah Park{{% /game %}}
...
*1–4 players, 30–45 minutes, 10+ years, medium light (1.9), 54% {{% kdj %}}Kennerspiel{{% /kdj %}}*
...
## #5: {{% game 316554 %}}Dune: Imperium{{% /game %}}
...
*1–5 players, 30 minutes, 14+ years, medium light (1.7), 87% {{% kdj %}}Kennerspiel{{% /kdj %}}*
...
## #9: {{% game 308765 %}}Praga Caput Regni{{% /game %}}
...
## #11: {{% game 304783 %}}Hadrian's Wall{{% /game %}}
...
## #12: {{% game 304051 %}}Creature Comforts{{% /game %}}

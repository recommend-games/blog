...
* who at most **14 years old** (better yet 12 or even 10 years old)
* with a complexity rating of **2** (*medium light*) or less.

A {{% color "#193F4A" %}}***Kennerspiel des Jahres***{{% /color %}} needs to

* be playable in under **120 minutes** (better 90 minutes)
* by (at least) **3 to 4 players**
* who at most **14 years old** (better yet 12)
* with a complexity rating of **3.5** (*medium*), better 2.5 or less.

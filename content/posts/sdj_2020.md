...
## What the BoardGameGeek community would pick for {{% color "#E30613" %}}*Spiel des Jahres*{{% /color %}}
...
## What the BoardGameGeek community would pick for {{% color "#193F4A" %}}*Kennerspiel des Jahres*{{% /color %}}
...
* not widely available in Germany yet:
  ...
  * Trails of Tucana
  * Q.E. https://recommend.games/#/game/266830
  * On Tour https://boardgamegeek.com/boardgame/251412/tour
...
* too high age
  * King's dilemma https://recommend.games/#/game/245655
* too expensive
  * Cthulhu: Death May Die https://recommend.games/#/game/253344
* two player only (Watergate)
* too similar (Azul: Summer Pavilion)

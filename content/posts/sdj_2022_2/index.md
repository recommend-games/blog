...
share_img: /posts/spiel-des-jahres-2022-nominations/sdj-all.webp
...
* {{% game 342942 %}}Ark Nova{{% /game %}}: As expected, this heavyweight got the "{{% game 251247 %}}Barrage{{% /game %}} treatment" – a place on the longlist, but the jury made it clear that this game is outside the scope of a {{% kdj %}}Kennerspiel{{% /kdj %}}.
...
* {{% game 318560 %}}Witchstone{{% /game %}}: At #11 on the predictions list, I'm going to call this one a *very* near miss. It's been on many other lists too, so no surprise it got recommended by the jury.

...
A few closing facts, verified rather than assumed, because they're too good to get wrong.

🇪🇸 Spain's women won the World Cup in 2023, and the men's side already had one from 2010 — which already made them the **second nation ever**, after 🇩🇪 Germany, to hold titles on both sides. What 2026 adds is the rarer thing: because 🇪🇸 Spain's women are still the reigning champions when the men lift this trophy, 🇪🇸 Spain becomes the **first nation in history to hold both titles at the same time**. 🇩🇪 Germany's two stars, won decades apart on each side, never actually overlapped.

And going into 2030 — hosted jointly by 🇪🇸 Spain, 🇵🇹 Portugal and 🇲🇦 Morocco, with three centenary matches in 🇺🇾 Uruguay, 🇦🇷 Argentina and 🇵🇾 Paraguay — 🇪🇸 Spain will be the **first host nation in men's World Cup history to enter as the defending champion**. No prior host has managed it; the closest anyone came was 1934, when reigning champions 🇺🇾 Uruguay boycotted the tournament in host nation 🇮🇹 Italy rather than defend the title there. On the women's side this has happened before, just not where I first assumed: it wasn't 🇩🇪 Germany's home 2011 win as defending champions, it was 🇺🇸 USA in 2003, who inherited the hosting duties from 🇨🇳 China after the SARS outbreak and defended their 1999 title on home soil — the first, and so far only, country to host back-to-back Women's World Cups as reigning champions.

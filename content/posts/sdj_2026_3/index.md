---
title: Spiel des Jahres 2026 predictions – Part 2!
slug: spiel-des-jahres-2026-predictions-part-2
share_img: /posts/spiel-des-jahres-2026-predictions-part-2/sdj-all.webp
author: Markus Shepherd
type: post
date: 2026-07-08T22:00:00+03:00
tags:
  - SdJ
  - SdJ 2026
  - Spiel des Jahres
...
Which brings us to the elephant in the conference hall: will the jury "dare" to give the award to an app game? As before with legacy games, I'll resist the immediate instinct of claiming a pattern based on previous years. The jury certainly doesn't hesitate to recognise modern trends, going back to their very first list in 1979 when they recommended no fewer than three electronic games: {{% game 5749 %}}Simon{{% /game %}}, {{% game 16052 %}}Merlin{{% /game %}} and Chess Challenger Voice. Looking at the more recent past, they nominated {{% game 219215 %}}Werewords{{% /game %}} and {{% game 223321 %}}Detective{{% /game %}} in 2019 and gave a special award to {{% game 350636 %}}Unlock! Game Adventures{{% /game %}} in 2023. Those who do insist on the "nominations not winners" pattern should look at the {{% kindersdj %}}Kinderspiel{{% /kindersdj %}}: {{% game 33643 %}}Whoowasit?{{% /game %}} won the main award in 2008 (we'll get back to that one shortly) and {{% game 92644 %}}Schnappt Hubi!{{% /game %}} in 2012.
